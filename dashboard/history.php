    	...
    	<div class="wrapper">
      		...
      		<div class="content-wrapper">
        		<div class="page-title">
          			<div>
            			<h1><i class="fa fa-dashboard"></i> History Aplikasi Enkripsi dan Dekripsi RC4</h1>
          			</div>
          			<div>
            			<ul class="breadcrumb">
              				<li><i class="fa fa-home fa-lg"></i></li>
              				<li><a href="index.php">Dashboard</a></li>
              				<li>Daftar List Enkripsi dan Dekripsi RC4</li>
            			</ul>
          			</div>
        		</div>
        		<div class="row">
                  					...
                  					<table id="file" class="table striped">
                    					<thead>
                        					<tr>
                          						...
                          						<td><strong>Waktu Dibutuhkan</strong></td>
